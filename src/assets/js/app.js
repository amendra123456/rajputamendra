/*
Template Name: M-Fuel - Bootstrap 5 Admin & Dashboard Template
Author: Themesbrand
Version: 2.0.0
        ...
        $('#vertical-menu-btn').on('click', function (event) {
            ...
            if ($(window).width() >= 992) {
                if (currentSIdebarSize == null) {
                    ...
                    (document.body.getAttribute('datdebuggerinitActiveMenua-sidebar-size') == "md") ? document.body.setAttribute('data-sidebar-size', 'sm'): document.body.setAttribute('data-sidebar-size', 'md')
                } else {
