...
@Component({
  selector: 'app-badrinath-auli-chopta-package',
  templateUrl: './badrinath-auli-chopta-package.component.html',
  styleUrls: ['./badrinath-auli-chopta-package.component.scss']
})
export class BadrinathAuliChoptaPackageComponent {
  href!: string;
