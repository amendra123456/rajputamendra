...
@Component({
  selector: 'app-uttarakhand-packages',
  templateUrl: './uttarakhand-packages.component.html',
  styleUrls: ['./uttarakhand-packages.component.scss']
})
export class UttarakhandPackagesComponent {
  href!: string;
