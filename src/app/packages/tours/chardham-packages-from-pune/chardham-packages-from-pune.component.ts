...
@Component({
  selector: 'app-chardham-packages-from-pune',
  templateUrl: './chardham-packages-from-pune.component.html',
  styleUrls: ['./chardham-packages-from-pune.component.scss']
})
export class ChardhamPackagesFromPuneComponent {
  href!: string;
