...
@Component({
  selector: 'app-varanasi-packages',
  templateUrl: './varanasi-packages.component.html',
  styleUrls: ['./varanasi-packages.component.scss']
})
export class VaranasiPackagesComponent {
  href!: string;
