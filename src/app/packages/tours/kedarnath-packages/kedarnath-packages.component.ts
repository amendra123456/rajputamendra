...
@Component({
  selector: 'app-kedarnath-packages',
  templateUrl: './kedarnath-packages.component.html',
  styleUrls: ['./kedarnath-packages.component.scss']
})
export class KedarnathPackagesComponent {
  href!: string;
