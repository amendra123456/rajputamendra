...
@Component({
  selector: 'app-dodhaam-packages',
  templateUrl: './dodhaam-packages.component.html',
  styleUrls: ['./dodhaam-packages.component.scss']
})
export class DodhaamPackagesComponent {
  href!: string;
