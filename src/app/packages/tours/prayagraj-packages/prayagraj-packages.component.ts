...
@Component({
  selector: 'app-prayagraj-packages',
  templateUrl: './prayagraj-packages.component.html',
  styleUrls: ['./prayagraj-packages.component.scss']
})
export class PrayagrajPackagesComponent {
  href!: string;
