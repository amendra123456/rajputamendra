...
@Component({
  selector: 'app-ayodhya-packages',
  templateUrl: './ayodhya-packages.component.html',
  styleUrls: ['./ayodhya-packages.component.scss']
})
export class AyodhyaPackagesComponent {
  href!: string;
