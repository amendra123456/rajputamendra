...
@Component({
  selector: 'app-auli-chopta-packages',
  templateUrl: './auli-chopta-packages.component.html',
  styleUrls: ['./auli-chopta-packages.component.scss']
})
export class AuliChoptaPackagesComponent {
  href!: string;
