...
@Component({
  selector: 'app-badrinath-packages',
  templateUrl: './badrinath-packages.component.html',
  styleUrls: ['./badrinath-packages.component.scss']
})
export class BadrinathPackagesComponent {
  href!: string;
